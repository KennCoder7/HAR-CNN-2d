...
np.save('ADL_data/np_2d/np_data_2d_v1.npy', data_2d)
print("data_2d shape: ", data_2d.shape)
np.save('ADL_data/np_2d/np_labels_1d_v1.npy', num_labels)
print("num_labels: ", num_labels)
np.save('ADL_data/np_2d/np_real_str_labels_1d_v1.npy', labels)
print("real_labels: ", labels)
np.save('ADL_data/np_2d/np_unique_labels_1d_v1.npy', unique_labels)
print("unique_labels: ", unique_labels)
print("labels number: ", labels.shape[0])
np.save('ADL_data/np_2d/np_labels_2d_v1.npy', labels_2d)
